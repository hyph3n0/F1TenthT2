...
if("TRUE" STREQUAL "TRUE")
  set(pluginlib_SOURCE_PREFIX /home/f1tenthteam2/pleasework/src/pluginlib)
  set(pluginlib_DEVEL_PREFIX /home/f1tenthteam2/pleasework/devel_isolated/pluginlib)
  ...
  set(pluginlib_INSTALL_PREFIX /home/f1tenthteam2/pleasework/install_isolated)
...
if(NOT "/home/f1tenthteam2/pleasework/src/pluginlib/include;/usr/include " STREQUAL " ")
  set(pluginlib_INCLUDE_DIRS "")
  set(_include_dirs "/home/f1tenthteam2/pleasework/src/pluginlib/include;/usr/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pluginlib' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/f1tenthteam2/pleasework/src/pluginlib/${idir}'.  ${_report}")
    endif()
    _list_append_unique(pluginlib_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "/usr/lib/aarch64-linux-gnu/libboost_filesystem.so.1.74.0;/usr/lib/aarch64-linux-gnu/libtinyxml2.so")
