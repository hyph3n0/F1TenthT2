...
if("TRUE" STREQUAL "TRUE")
  set(cv_bridge_SOURCE_PREFIX /home/f1tenthteam2/pleasework/src/vision_opencv/cv_bridge)
  set(cv_bridge_DEVEL_PREFIX /home/f1tenthteam2/pleasework/devel_isolated/cv_bridge)
  ...
  set(cv_bridge_INSTALL_PREFIX /home/f1tenthteam2/pleasework/install_isolated)
...
if(NOT "/home/f1tenthteam2/pleasework/src/vision_opencv/cv_bridge/include;/usr/include/opencv4 " STREQUAL " ")
  set(cv_bridge_INCLUDE_DIRS "")
  set(_include_dirs "/home/f1tenthteam2/pleasework/src/vision_opencv/cv_bridge/include;/usr/include/opencv4")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cv_bridge' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/f1tenthteam2/pleasework/src/vision_opencv/cv_bridge/${idir}'.  ${_report}")
    endif()
    _list_append_unique(cv_bridge_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "cv_bridge;/usr/lib/aarch64-linux-gnu/libopencv_calib3d.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_dnn.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_features2d.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_flann.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_highgui.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_ml.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_objdetect.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_photo.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_stitching.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_video.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_videoio.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_alphamat.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_aruco.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_barcode.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_bgsegm.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_bioinspired.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_ccalib.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_datasets.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_dnn_objdetect.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_dnn_superres.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_dpm.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_face.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_freetype.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_fuzzy.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_hdf.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_hfs.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_img_hash.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_intensity_transform.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_line_descriptor.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_mcc.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_optflow.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_phase_unwrapping.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_plot.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_quality.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_rapid.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_reg.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_rgbd.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_saliency.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_shape.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_stereo.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_structured_light.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_superres.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_surface_matching.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_text.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_tracking.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_videostab.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_viz.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_wechat_qrcode.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_ximgproc.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_xobjdetect.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_xphoto.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_core.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_imgproc.so.4.5.4d;/usr/lib/aarch64-linux-gnu/libopencv_imgcodecs.so.4.5.4d")
