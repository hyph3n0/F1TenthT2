...
if(vesc_hw_interface_CONFIG_INCLUDED)
  return()
endif()
set(vesc_hw_interface_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(vesc_hw_interface_SOURCE_PREFIX /home/f1tenthteam2/pleasework/src/vesc/vesc_hw_interface)
  set(vesc_hw_interface_DEVEL_PREFIX /home/f1tenthteam2/pleasework/devel_isolated/vesc_hw_interface)
  set(vesc_hw_interface_INSTALL_PREFIX "")
  set(vesc_hw_interface_PREFIX ${vesc_hw_interface_DEVEL_PREFIX})
else()
  set(vesc_hw_interface_SOURCE_PREFIX "")
  set(vesc_hw_interface_DEVEL_PREFIX "")
  set(vesc_hw_interface_INSTALL_PREFIX /home/f1tenthteam2/pleasework/install_isolated)
  set(vesc_hw_interface_PREFIX ${vesc_hw_interface_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'vesc_hw_interface' is deprecated")
...
set(vesc_hw_interface_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/f1tenthteam2/pleasework/src/vesc/vesc_hw_interface/include " STREQUAL " ")
  set(vesc_hw_interface_INCLUDE_DIRS "")
  set(_include_dirs "/home/f1tenthteam2/pleasework/src/vesc/vesc_hw_interface/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'SoftBank Corp. <SBGRP-git@g.softbank.co.jp>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${vesc_hw_interface_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'vesc_hw_interface' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'vesc_hw_interface' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/f1tenthteam2/pleasework/src/vesc/vesc_hw_interface/${idir}'.  ${_report}")
    endif()
    _list_append_unique(vesc_hw_interface_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "vesc_hw_interface")
foreach(library ${libraries})
  # keep build configuration keywords, target names and absolute libraries as-is
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND vesc_hw_interface_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND vesc_hw_interface_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT vesc_hw_interface_NUM_DUMMY_TARGETS)
      set(vesc_hw_interface_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::vesc_hw_interface::wrapped-linker-option${vesc_hw_interface_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR vesc_hw_interface_NUM_DUMMY_TARGETS "${vesc_hw_interface_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::vesc_hw_interface::wrapped-linker-option${vesc_hw_interface_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND vesc_hw_interface_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(vesc_hw_interface_LIBRARY_DIRS ${lib_path})
      list(APPEND vesc_hw_interface_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'vesc_hw_interface'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND vesc_hw_interface_LIBRARIES ${lib})
    endif()
  endif()
...
set(vesc_hw_interface_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${vesc_hw_interface_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "roscpp;serial;hardware_interface;joint_limits_interface;controller_manager;pluginlib;urdf;vesc_driver;angles")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 vesc_hw_interface_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${vesc_hw_interface_dep}_FOUND)
      find_package(${vesc_hw_interface_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${vesc_hw_interface_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(vesc_hw_interface_INCLUDE_DIRS ${${vesc_hw_interface_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(vesc_hw_interface_LIBRARIES ${vesc_hw_interface_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${vesc_hw_interface_dep}_LIBRARIES})
  _list_append_deduplicate(vesc_hw_interface_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(vesc_hw_interface_LIBRARIES ${vesc_hw_interface_LIBRARIES})

  _list_append_unique(vesc_hw_interface_LIBRARY_DIRS ${${vesc_hw_interface_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(vesc_hw_interface_EXPORTED_TARGETS ${${vesc_hw_interface_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${vesc_hw_interface_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
