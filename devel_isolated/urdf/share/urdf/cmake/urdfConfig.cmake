...
if("TRUE" STREQUAL "TRUE")
  set(urdf_SOURCE_PREFIX /home/f1tenthteam2/pleasework/src/urdf/urdf)
  set(urdf_DEVEL_PREFIX /home/f1tenthteam2/pleasework/devel_isolated/urdf)
  set(urdf_INSTALL_PREFIX "")
  set(urdf_PREFIX ${urdf_DEVEL_PREFIX})
else()
  set(urdf_SOURCE_PREFIX "")
  set(urdf_DEVEL_PREFIX "")
  set(urdf_INSTALL_PREFIX /home/f1tenthteam2/pleasework/install_isolated)
...
if(NOT "/home/f1tenthteam2/pleasework/src/urdf/urdf/include;/home/f1tenthteam2/pleasework/devel_isolated/urdf/include;/usr/include;/usr/lib/aarch64-linux-gnu/urdfdom/cmake/../../../../include " STREQUAL " ")
  set(urdf_INCLUDE_DIRS "")
  set(_include_dirs "/home/f1tenthteam2/pleasework/src/urdf/urdf/include;/home/f1tenthteam2/pleasework/devel_isolated/urdf/include;/usr/include;/usr/lib/aarch64-linux-gnu/urdfdom/cmake/../../../../include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'urdf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/f1tenthteam2/pleasework/src/urdf/urdf/${idir}'.  ${_report}")
    endif()
    _list_append_unique(urdf_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "urdf;/usr/lib/aarch64-linux-gnu/liburdfdom_sensor.so;/usr/lib/aarch64-linux-gnu/liburdfdom_model_state.so;/usr/lib/aarch64-linux-gnu/liburdfdom_model.so;/usr/lib/aarch64-linux-gnu/liburdfdom_world.so;/usr/lib/aarch64-linux-gnu/libconsole_bridge.so.1.0;/usr/lib/aarch64-linux-gnu/libboost_thread.so.1.74.0;/usr/lib/aarch64-linux-gnu/libtinyxml.so;/usr/lib/aarch64-linux-gnu/libtinyxml2.so")
