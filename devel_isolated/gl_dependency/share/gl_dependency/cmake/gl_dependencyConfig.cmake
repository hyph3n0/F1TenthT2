...
if("TRUE" STREQUAL "TRUE")
  set(gl_dependency_SOURCE_PREFIX /home/f1tenthteam2/pleasework/src/gl_dependency)
  set(gl_dependency_DEVEL_PREFIX /home/f1tenthteam2/pleasework/devel_isolated/gl_dependency)
  ...
  set(gl_dependency_INSTALL_PREFIX /home/f1tenthteam2/pleasework/install_isolated)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gl_dependency' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/f1tenthteam2/pleasework/src/gl_dependency/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT gl_dependency_NUM_DUMMY_TARGETS)
      set(gl_dependency_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::gl_dependency::wrapped-linker-option${gl_dependency_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR gl_dependency_NUM_DUMMY_TARGETS "${gl_dependency_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::gl_dependency::wrapped-linker-option${gl_dependency_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND gl_dependency_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(gl_dependency_EXPORTED_TARGETS ${${gl_dependency_dep}_EXPORTED_TARGETS})
endforeach()
