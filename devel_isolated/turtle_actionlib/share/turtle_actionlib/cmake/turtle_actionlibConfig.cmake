...
if("TRUE" STREQUAL "TRUE")
  set(turtle_actionlib_SOURCE_PREFIX /home/f1tenthteam2/pleasework/src/common_tutorials/turtle_actionlib)
  set(turtle_actionlib_DEVEL_PREFIX /home/f1tenthteam2/pleasework/devel_isolated/turtle_actionlib)
  ...
  set(turtle_actionlib_INSTALL_PREFIX /home/f1tenthteam2/pleasework/install_isolated)
...
if(NOT "/home/f1tenthteam2/pleasework/devel_isolated/turtle_actionlib/include " STREQUAL " ")
  set(turtle_actionlib_INCLUDE_DIRS "")
  set(_include_dirs "/home/f1tenthteam2/pleasework/devel_isolated/turtle_actionlib/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'turtle_actionlib' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/f1tenthteam2/pleasework/src/common_tutorials/turtle_actionlib/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT turtle_actionlib_NUM_DUMMY_TARGETS)
      set(turtle_actionlib_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::turtle_actionlib::wrapped-linker-option${turtle_actionlib_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR turtle_actionlib_NUM_DUMMY_TARGETS "${turtle_actionlib_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::turtle_actionlib::wrapped-linker-option${turtle_actionlib_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND turtle_actionlib_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(turtle_actionlib_EXPORTED_TARGETS ${${turtle_actionlib_dep}_EXPORTED_TARGETS})
endforeach()
