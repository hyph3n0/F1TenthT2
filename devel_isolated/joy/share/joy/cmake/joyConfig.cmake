...
if("TRUE" STREQUAL "TRUE")
  set(joy_SOURCE_PREFIX /home/f1tenthteam2/pleasework/src/joystick_drivers/joy)
  set(joy_DEVEL_PREFIX /home/f1tenthteam2/pleasework/devel_isolated/joy)
  set(joy_INSTALL_PREFIX "")
  set(joy_PREFIX ${joy_DEVEL_PREFIX})
else()
  set(joy_SOURCE_PREFIX "")
  set(joy_DEVEL_PREFIX "")
  set(joy_INSTALL_PREFIX /home/f1tenthteam2/pleasework/install_isolated)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'joy' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/f1tenthteam2/pleasework/src/joystick_drivers/joy/${idir}'.  ${_report}")
    endif()
