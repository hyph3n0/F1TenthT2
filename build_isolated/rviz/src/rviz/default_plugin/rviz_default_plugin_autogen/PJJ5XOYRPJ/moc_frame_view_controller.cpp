...
QT_MOC_LITERAL(1, 26, 18), // "changedOrientation"
QT_MOC_LITERAL(2, 45, 0), // ""
QT_MOC_LITERAL(3, 46, 11) // "changedAxis"

    },
    "rviz::FrameViewController\0changedOrientation\0"
    "\0changedAxis"
};
...
void rviz::FrameViewController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<FrameViewController *>(_o);
        (void)_t;
        switch (_id) {
        case 0: _t->changedOrientation(); break;
        case 1: _t->changedAxis(); break;
        default: ;
        }
    }
    (void)_a;
...
QT_INIT_METAOBJECT const QMetaObject rviz::FrameViewController::staticMetaObject = { {
    QMetaObject::SuperData::link<FPSViewController::staticMetaObject>(),
    qt_meta_stringdata_rviz__FrameViewController.data,
    qt_meta_data_rviz__FrameViewController,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *rviz::FrameViewController::qt_metacast(const char *_clname)
{
    ...
    return FPSViewController::qt_metacast(_clname);
}

int rviz::FrameViewController::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = FPSViewController::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 2)
