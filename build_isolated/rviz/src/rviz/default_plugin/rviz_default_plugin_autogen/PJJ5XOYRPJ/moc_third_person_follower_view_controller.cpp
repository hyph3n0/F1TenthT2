...
QT_INIT_METAOBJECT const QMetaObject rviz::ThirdPersonFollowerViewController::staticMetaObject = { {
    QMetaObject::SuperData::link<OrbitViewController::staticMetaObject>(),
    qt_meta_stringdata_rviz__ThirdPersonFollowerViewController.data,
    qt_meta_data_rviz__ThirdPersonFollowerViewController,
    qt_static_metacall,
    nullptr,
    nullptr
} };
