...
void rviz::InteractiveMarker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (InteractiveMarker::*)(visualization_msgs::InteractiveMarkerFeedback & );
        ...
        {
            using _t = void (InteractiveMarker::*)(StatusProperty::Level , const std::string & , const std::string & );
...
QT_INIT_METAOBJECT const QMetaObject rviz::InteractiveMarker::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_rviz__InteractiveMarker.data,
    qt_meta_data_rviz__InteractiveMarker,
    qt_static_metacall,
    nullptr,
    nullptr
} };
