...
void rviz::IntegerAction::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<IntegerAction *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (IntegerAction::*)(int );
...
QT_INIT_METAOBJECT const QMetaObject rviz::IntegerAction::staticMetaObject = { {
    QMetaObject::SuperData::link<QAction::staticMetaObject>(),
    qt_meta_stringdata_rviz__IntegerAction.data,
    qt_meta_data_rviz__IntegerAction,
    qt_static_metacall,
    nullptr,
    nullptr
} };
