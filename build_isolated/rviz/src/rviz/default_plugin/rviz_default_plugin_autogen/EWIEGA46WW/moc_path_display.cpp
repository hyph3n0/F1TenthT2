...
void rviz::PathDisplay::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PathDisplay *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject rviz::PathDisplay::staticMetaObject = { {
    QMetaObject::SuperData::link<MessageFilterDisplay<nav_msgs::Path>::staticMetaObject>(),
    qt_meta_stringdata_rviz__PathDisplay.data,
    qt_meta_data_rviz__PathDisplay,
    qt_static_metacall,
    nullptr,
    nullptr
} };
