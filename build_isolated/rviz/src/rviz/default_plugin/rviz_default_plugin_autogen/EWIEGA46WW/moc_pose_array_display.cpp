...
void rviz::PoseArrayDisplay::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PoseArrayDisplay *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject rviz::PoseArrayDisplay::staticMetaObject = { {
    QMetaObject::SuperData::link<MessageFilterDisplay<geometry_msgs::PoseArray>::staticMetaObject>(),
    qt_meta_stringdata_rviz__PoseArrayDisplay.data,
    qt_meta_data_rviz__PoseArrayDisplay,
    qt_static_metacall,
    nullptr,
    nullptr
} };
