...
QT_INIT_METAOBJECT const QMetaObject rviz::InteractiveMarkerDisplay::staticMetaObject = { {
    QMetaObject::SuperData::link<Display::staticMetaObject>(),
    qt_meta_stringdata_rviz__InteractiveMarkerDisplay.data,
    qt_meta_data_rviz__InteractiveMarkerDisplay,
    qt_static_metacall,
    nullptr,
    nullptr
} };
