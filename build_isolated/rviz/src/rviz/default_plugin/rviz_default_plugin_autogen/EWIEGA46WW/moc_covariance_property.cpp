...
void rviz::CovarianceProperty::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CovarianceProperty *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject rviz::CovarianceProperty::staticMetaObject = { {
    QMetaObject::SuperData::link<rviz::BoolProperty::staticMetaObject>(),
    qt_meta_stringdata_rviz__CovarianceProperty.data,
    qt_meta_data_rviz__CovarianceProperty,
    qt_static_metacall,
    nullptr,
    nullptr
} };
