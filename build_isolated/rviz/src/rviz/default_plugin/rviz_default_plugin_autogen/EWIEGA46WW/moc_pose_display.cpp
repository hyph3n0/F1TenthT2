...
void rviz::PoseDisplay::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PoseDisplay *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject rviz::PoseDisplay::staticMetaObject = { {
    QMetaObject::SuperData::link<MessageFilterDisplay<geometry_msgs::PoseStamped>::staticMetaObject>(),
    qt_meta_stringdata_rviz__PoseDisplay.data,
    qt_meta_data_rviz__PoseDisplay,
    qt_static_metacall,
    nullptr,
    nullptr
} };
