...
QT_INIT_METAOBJECT const QMetaObject rviz::PointCloud2Display::staticMetaObject = { {
    QMetaObject::SuperData::link<MessageFilterDisplay<sensor_msgs::PointCloud2>::staticMetaObject>(),
    qt_meta_stringdata_rviz__PointCloud2Display.data,
    qt_meta_data_rviz__PointCloud2Display,
    qt_static_metacall,
    nullptr,
    nullptr
} };
