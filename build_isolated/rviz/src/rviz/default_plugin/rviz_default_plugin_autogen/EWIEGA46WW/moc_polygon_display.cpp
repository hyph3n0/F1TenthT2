...
QT_INIT_METAOBJECT const QMetaObject rviz::PolygonDisplay::staticMetaObject = { {
    QMetaObject::SuperData::link<MessageFilterDisplay<geometry_msgs::PolygonStamped>::staticMetaObject>(),
    qt_meta_stringdata_rviz__PolygonDisplay.data,
    qt_meta_data_rviz__PolygonDisplay,
    qt_static_metacall,
    nullptr,
    nullptr
} };
