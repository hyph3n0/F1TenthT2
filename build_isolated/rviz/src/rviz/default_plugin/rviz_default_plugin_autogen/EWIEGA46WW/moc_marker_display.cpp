...
void rviz::MarkerDisplay::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MarkerDisplay *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject rviz::MarkerDisplay::staticMetaObject = { {
    QMetaObject::SuperData::link<Display::staticMetaObject>(),
    qt_meta_stringdata_rviz__MarkerDisplay.data,
    qt_meta_data_rviz__MarkerDisplay,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MarkerNamespace *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject rviz::MarkerNamespace::staticMetaObject = { {
    QMetaObject::SuperData::link<BoolProperty::staticMetaObject>(),
    qt_meta_stringdata_rviz__MarkerNamespace.data,
    qt_meta_data_rviz__MarkerNamespace,
    qt_static_metacall,
    nullptr,
    nullptr
} };
