...
QT_INIT_METAOBJECT const QMetaObject rviz::RosFilteredTopicProperty::staticMetaObject = { {
    QMetaObject::SuperData::link<RosTopicProperty::staticMetaObject>(),
    qt_meta_stringdata_rviz__RosFilteredTopicProperty.data,
    qt_meta_data_rviz__RosFilteredTopicProperty,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<DepthCloudDisplay *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject rviz::DepthCloudDisplay::staticMetaObject = { {
    QMetaObject::SuperData::link<rviz::Display::staticMetaObject>(),
    qt_meta_stringdata_rviz__DepthCloudDisplay.data,
    qt_meta_data_rviz__DepthCloudDisplay,
    qt_static_metacall,
    nullptr,
    nullptr
} };
