...
void rviz::RangeDisplay::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<RangeDisplay *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject rviz::RangeDisplay::staticMetaObject = { {
    QMetaObject::SuperData::link<MessageFilterDisplay<sensor_msgs::Range>::staticMetaObject>(),
    qt_meta_stringdata_rviz__RangeDisplay.data,
    qt_meta_data_rviz__RangeDisplay,
    qt_static_metacall,
    nullptr,
    nullptr
} };
