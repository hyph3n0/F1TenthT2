...
void rviz::GridCellsDisplay::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<GridCellsDisplay *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject rviz::GridCellsDisplay::staticMetaObject = { {
    QMetaObject::SuperData::link<MessageFilterDisplay<nav_msgs::GridCells>::staticMetaObject>(),
    qt_meta_stringdata_rviz__GridCellsDisplay.data,
    qt_meta_data_rviz__GridCellsDisplay,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *rviz::GridCellsDisplay::qt_metacast(const char *_clname)
{
    ...
    return MessageFilterDisplay<nav_msgs::GridCells>::qt_metacast(_clname);
}

int rviz::GridCellsDisplay::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = MessageFilterDisplay<nav_msgs::GridCells>::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 1)
