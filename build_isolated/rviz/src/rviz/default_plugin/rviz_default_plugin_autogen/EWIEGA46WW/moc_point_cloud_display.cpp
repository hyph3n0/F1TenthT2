...
QT_INIT_METAOBJECT const QMetaObject rviz::PointCloudDisplay::staticMetaObject = { {
    QMetaObject::SuperData::link<MessageFilterDisplay<sensor_msgs::PointCloud>::staticMetaObject>(),
    qt_meta_stringdata_rviz__PointCloudDisplay.data,
    qt_meta_data_rviz__PointCloudDisplay,
    qt_static_metacall,
    nullptr,
    nullptr
} };
