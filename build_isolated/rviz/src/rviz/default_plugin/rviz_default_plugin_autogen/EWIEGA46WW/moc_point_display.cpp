...
void rviz::PointStampedDisplay::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PointStampedDisplay *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject rviz::PointStampedDisplay::staticMetaObject = { {
    QMetaObject::SuperData::link<rviz::MessageFilterDisplay<geometry_msgs::PointStamped>::staticMetaObject>(),
    qt_meta_stringdata_rviz__PointStampedDisplay.data,
    qt_meta_data_rviz__PointStampedDisplay,
    qt_static_metacall,
    nullptr,
    nullptr
} };
