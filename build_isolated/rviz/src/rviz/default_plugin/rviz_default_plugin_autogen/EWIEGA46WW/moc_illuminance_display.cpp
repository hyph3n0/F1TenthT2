...
QT_INIT_METAOBJECT const QMetaObject rviz::IlluminanceDisplay::staticMetaObject = { {
    QMetaObject::SuperData::link<MessageFilterDisplay<sensor_msgs::Illuminance>::staticMetaObject>(),
    qt_meta_stringdata_rviz__IlluminanceDisplay.data,
    qt_meta_data_rviz__IlluminanceDisplay,
    qt_static_metacall,
    nullptr,
    nullptr
} };
