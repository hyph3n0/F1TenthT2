...
void rviz::PoseWithCovarianceDisplay::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PoseWithCovarianceDisplay *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject rviz::PoseWithCovarianceDisplay::staticMetaObject = { {
    QMetaObject::SuperData::link<rviz::MessageFilterDisplay<geometry_msgs::PoseWithCovarianceStamped>::staticMetaObject>(),
    qt_meta_stringdata_rviz__PoseWithCovarianceDisplay.data,
    qt_meta_data_rviz__PoseWithCovarianceDisplay,
    qt_static_metacall,
    nullptr,
    nullptr
} };
