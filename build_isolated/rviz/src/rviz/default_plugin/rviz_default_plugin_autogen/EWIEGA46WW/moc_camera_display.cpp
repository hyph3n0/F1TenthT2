...
void rviz::CameraDisplay::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CameraDisplay *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject rviz::CameraDisplay::staticMetaObject = { {
    QMetaObject::SuperData::link<ImageDisplayBase::staticMetaObject>(),
    qt_meta_stringdata_rviz__CameraDisplay.data,
    qt_meta_data_rviz__CameraDisplay,
    qt_static_metacall,
    nullptr,
    nullptr
} };
