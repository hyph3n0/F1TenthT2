...
QT_MOC_LITERAL(5, 51, 15), // "toggleMaximized"
QT_MOC_LITERAL(6, 67, 18), // "overrideVisibility"
QT_MOC_LITERAL(7, 86, 4), // "hide"
QT_MOC_LITERAL(8, 91, 16) // "onChildDestroyed"

    },
    "rviz::PanelDockWidget\0closed\0\0"
    "setWindowTitle\0title\0toggleMaximized\0"
    "overrideVisibility\0hide\0onChildDestroyed"
};
...
void rviz::PanelDockWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PanelDockWidget *>(_o);
        (void)_t;
        switch (_id) {
        case 0: _t->closed(); break;
        case 1: _t->setWindowTitle((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 2: _t->toggleMaximized(); break;
        case 3: _t->overrideVisibility((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 4: _t->onChildDestroyed((*reinterpret_cast< QObject*(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (PanelDockWidget::*)();
...
QT_INIT_METAOBJECT const QMetaObject rviz::PanelDockWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QDockWidget::staticMetaObject>(),
    qt_meta_stringdata_rviz__PanelDockWidget.data,
    qt_meta_data_rviz__PanelDockWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
