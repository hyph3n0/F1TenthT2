...
QT_INIT_METAOBJECT const QMetaObject rviz::NewObjectDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_rviz__NewObjectDialog.data,
    qt_meta_data_rviz__NewObjectDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
