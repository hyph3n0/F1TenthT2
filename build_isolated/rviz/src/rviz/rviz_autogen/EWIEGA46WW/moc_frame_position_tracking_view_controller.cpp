...
void rviz::FramePositionTrackingViewController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<FramePositionTrackingViewController *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject rviz::FramePositionTrackingViewController::staticMetaObject = { {
    QMetaObject::SuperData::link<ViewController::staticMetaObject>(),
    qt_meta_stringdata_rviz__FramePositionTrackingViewController.data,
    qt_meta_data_rviz__FramePositionTrackingViewController,
    qt_static_metacall,
    nullptr,
    nullptr
} };
