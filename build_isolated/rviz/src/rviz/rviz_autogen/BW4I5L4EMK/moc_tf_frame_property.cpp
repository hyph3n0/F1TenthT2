...
QT_INIT_METAOBJECT const QMetaObject rviz::TfFrameProperty::staticMetaObject = { {
    QMetaObject::SuperData::link<EditableEnumProperty::staticMetaObject>(),
    qt_meta_stringdata_rviz__TfFrameProperty.data,
    qt_meta_data_rviz__TfFrameProperty,
    qt_static_metacall,
    nullptr,
    nullptr
} };
