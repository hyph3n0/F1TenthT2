...
void rviz::EditableEnumProperty::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<EditableEnumProperty *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (EditableEnumProperty::*)(EditableEnumProperty * );
...
QT_INIT_METAOBJECT const QMetaObject rviz::EditableEnumProperty::staticMetaObject = { {
    QMetaObject::SuperData::link<StringProperty::staticMetaObject>(),
    qt_meta_stringdata_rviz__EditableEnumProperty.data,
    qt_meta_data_rviz__EditableEnumProperty,
    qt_static_metacall,
    nullptr,
    nullptr
} };
