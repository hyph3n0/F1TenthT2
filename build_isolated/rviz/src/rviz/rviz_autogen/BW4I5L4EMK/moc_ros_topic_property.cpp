...
QT_INIT_METAOBJECT const QMetaObject rviz::RosTopicProperty::staticMetaObject = { {
    QMetaObject::SuperData::link<EditableEnumProperty::staticMetaObject>(),
    qt_meta_stringdata_rviz__RosTopicProperty.data,
    qt_meta_data_rviz__RosTopicProperty,
    qt_static_metacall,
    nullptr,
    nullptr
} };
