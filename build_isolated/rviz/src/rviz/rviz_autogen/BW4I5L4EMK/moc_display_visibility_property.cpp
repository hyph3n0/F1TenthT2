...
QT_INIT_METAOBJECT const QMetaObject rviz::DisplayVisibilityProperty::staticMetaObject = { {
    QMetaObject::SuperData::link<BoolProperty::staticMetaObject>(),
    qt_meta_stringdata_rviz__DisplayVisibilityProperty.data,
    qt_meta_data_rviz__DisplayVisibilityProperty,
    qt_static_metacall,
    nullptr,
    nullptr
} };
