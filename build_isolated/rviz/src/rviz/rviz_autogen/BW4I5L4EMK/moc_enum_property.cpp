...
void rviz::EnumProperty::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<EnumProperty *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (EnumProperty::*)(EnumProperty * );
...
QT_INIT_METAOBJECT const QMetaObject rviz::EnumProperty::staticMetaObject = { {
    QMetaObject::SuperData::link<StringProperty::staticMetaObject>(),
    qt_meta_stringdata_rviz__EnumProperty.data,
    qt_meta_data_rviz__EnumProperty,
    qt_static_metacall,
    nullptr,
    nullptr
} };
