...
void rviz::VectorProperty::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<VectorProperty *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject rviz::VectorProperty::staticMetaObject = { {
    QMetaObject::SuperData::link<Property::staticMetaObject>(),
    qt_meta_stringdata_rviz__VectorProperty.data,
    qt_meta_data_rviz__VectorProperty,
    qt_static_metacall,
    nullptr,
    nullptr
} };
