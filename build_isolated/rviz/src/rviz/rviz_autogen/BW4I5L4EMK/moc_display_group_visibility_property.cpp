...
QT_INIT_METAOBJECT const QMetaObject rviz::DisplayGroupVisibilityProperty::staticMetaObject = { {
    QMetaObject::SuperData::link<DisplayVisibilityProperty::staticMetaObject>(),
    qt_meta_stringdata_rviz__DisplayGroupVisibilityProperty.data,
    qt_meta_data_rviz__DisplayGroupVisibilityProperty,
    qt_static_metacall,
    nullptr,
    nullptr
} };
