...
set(MSG_I_FLAGS "-Idriver_base:/home/f1tenthteam2/pleasework/src/driver_common/driver_base/msg;-Istd_msgs:/home/f1tenthteam2/pleasework/src/std_msgs/msg")
...
get_filename_component(_filename "/home/f1tenthteam2/pleasework/src/driver_common/driver_base/msg/ConfigString.msg" NAME_WE)
add_custom_target(_driver_base_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "driver_base" "/home/f1tenthteam2/pleasework/src/driver_common/driver_base/msg/ConfigString.msg" ""
)

get_filename_component(_filename "/home/f1tenthteam2/pleasework/src/driver_common/driver_base/msg/ConfigValue.msg" NAME_WE)
add_custom_target(_driver_base_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "driver_base" "/home/f1tenthteam2/pleasework/src/driver_common/driver_base/msg/ConfigValue.msg" ""
)

get_filename_component(_filename "/home/f1tenthteam2/pleasework/src/driver_common/driver_base/msg/SensorLevels.msg" NAME_WE)
add_custom_target(_driver_base_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "driver_base" "/home/f1tenthteam2/pleasework/src/driver_common/driver_base/msg/SensorLevels.msg" ""
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/driver_base)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/driver_base\")")
  # install generated code
  install(
