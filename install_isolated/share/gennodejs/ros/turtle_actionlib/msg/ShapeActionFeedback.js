...
class ShapeActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new ShapeFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ShapeFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ShapeActionFeedback(null);
    ...
    data.feedback = ShapeFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ShapeActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = ShapeFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new ShapeFeedback()
    }
...
module.exports = ShapeActionFeedback;
